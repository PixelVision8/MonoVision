...
namespace MonoGame.Utilities
{
    internal class FuncLoader
    {
        ...
        public static IntPtr LoadLibraryExt(string libname)
        {
            ...
            // TODO this is now hardcoded to libraries/sdl/
            var assemblyLocation = Path.GetDirectoryName(typeof(FuncLoader).Assembly.Location) + "/libraries/sdl/" ?? "./";
            ...
            if (ret == IntPtr.Zero)
                ret = LoadLibrary(Path.Combine(assemblyLocation, "sdl", CurrentPlatform.Rid, "native", libname));
